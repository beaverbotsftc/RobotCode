...
public class TurretTuningFar extends CommandOpMode {
    ...
    public void periodic() {
        ...
        addData("Distance to goal", localizer.getPosition().subtract(new Transform(-72, 72)).lateralNorm());
        ...
        intake.intake((gamepad.getRightTrigger() - gamepad.getLeftTrigger()) * 0.5);
    }
}
