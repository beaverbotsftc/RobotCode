...
public class PathFollowerTuningV extends LinearOpMode {
    ...
    final HashMap<DOFs.DOF, Double> initalGuess = TuningConstants.v;
        ...
        while (opModeIsActive()) {
            ...
            PathFollower pathFollower = new PathFollower(path, dofs,
                    ...
                    new HashMap<DOFs.DOF, PathFollower.K>() {
                        {
                            for (DOFs.DOF dof : DOFs.DOF.values()) put(dof, new PathFollower.K(guess.get(dof), TuningConstants.a.get(dof), 0));
                        }
