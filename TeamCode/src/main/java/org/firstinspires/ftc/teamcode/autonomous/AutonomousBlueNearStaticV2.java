...
public class AutonomousBlueNearStaticV2 extends CommandRuntimeOpMode {
    ...
    public void onStart() {
        Pair<Path, Path> autoPart1 = new PathBuilder(pinpoint.getPositionAsList())
                .linearTo(new DrivetrainState(93.67, 144 - 51.38, 0.69 + 0.1).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .build();

        Pair<Path, Path> autoPart2 = new PathBuilder(autoPart1.second)
                .linearTo(new DrivetrainState(85.85, 144 - 55.95, Math.PI / 2).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .linearTo(new DrivetrainState(85.85, 144 - 25, Math.PI / 2).toList(), 0.3, 3)
                .stop(0.3, 0.5)
                .build();
        ...
        Pair<Path, Path> autoPart4 = new PathBuilder(autoPart3.second)
                .linearTo(new DrivetrainState(63.85, 144 - 55.95, Math.PI / 2).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .linearTo(new DrivetrainState(63.85, 144 - 25, Math.PI / 2).toList(), 0.3, 3)
                .stop(0.3, 0.5)
                .build();
        ...
        Pair<Path, Path> autoPart6 = new PathBuilder(autoPart5.second)
                .linearTo(new DrivetrainState(120, 144 - 51.38, 0.69 + 0.1).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .build();
