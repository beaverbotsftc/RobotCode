...
public class RevBlinkinLedDriverTest extends OpMode {
    ...
    protected void handleGamepad()
    {
        ...
        if ((displayKind == DisplayKind.MANUAL) && (gamepad1.left_bumper)) {
            ...
            displayPattern();
            gamepadRateLimit.reset();
        } else if ((displayKind == DisplayKind.MANUAL) && (gamepad1.square)){
            pattern = RevBlinkinLedDriver.BlinkinPattern.HOT_PINK;
        } else if ((displayKind == DisplayKind.MANUAL) && (gamepad1.circle)){
