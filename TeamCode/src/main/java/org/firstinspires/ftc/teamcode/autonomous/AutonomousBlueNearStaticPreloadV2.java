...
public class AutonomousBlueNearStaticPreloadV2 extends CommandRuntimeOpMode {
    ...
    public void onStart() {
        Pair<Path, Path> autoPart1 = new PathBuilder(pinpoint.getPositionAsList())
                .linearTo(new DrivetrainState(93.67, 144 - 51.38, 0.69).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .build();

        Pair<Path, Path> autoPart6 = new PathBuilder(autoPart1.second)
                .linearTo(new DrivetrainState(120, 144 - 51.38, 0.69).toList(), 0.3, 1)
                .stop(0.3, 0.5)
                .build();
        ...
        schedule(
                new Sequential(
                        ...
                        new RunUntil(
                                new Sequential(
                                        new WaitUntil(() -> Math.abs(shooter.getVelocity() - 2200) < 50),
